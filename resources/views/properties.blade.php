   ...
   <div class="site-blocks-cover inner-page-cover overlay" style="background-image: {{url('/public/images/hero_bg_2.jpg')}};" data-aos="fade" data-stellar-background-ratio="0.5">
    ...
    <div class="site-section site-section-sm bg-light">
      <div class="container">
        ...
        ?>
        <div class="row mb-5">
          @foreach($properties1 as $pro)
            
          <div class="col-md-6 col-lg-4 mb-4">
            <a href="{{url('/property-details'.'/'.$pro->id)}}" class="prop-entry d-block">
              <figure>
                <img src="{{ url($pro->image)}}" height="350px" alt="Image" class="img-fluid">
              </figure>
              <div class="prop-text">
                <div class="inner">
                  <span class="price rounded">${{$pro->price}}</span>
                  <h3 class="title">{{$pro->description}}</h3>
                  <p class="location">{{$pro->address}}</p>
                </div>
                <div class="p-more-info">
                  <div class="inner d-flex">
                    <div class="col">
                      <span>Area:</span>
                      <strong>{{$pro->build_Area}}m<sup>2</sup></strong>
                    </div>
                    <div class="col">
                      <span>Beds:</span>
                      <strong>{{$pro->bedroom}}</strong>
                    </div>
                    <div class="col">
                      <span>Baths:</span>
                      <strong>{{$pro->bathroom}}</strong>
                    </div>
                    <div class="col">
                      <span>Garages:</span>
                      <strong>{{$pro->garage}}</strong>
                    </div>
                  </div>
                </div>
              </div>
